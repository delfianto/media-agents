...
| [**`quality-compare`**](skills/quality-compare) | Deeply compares encoded videos or compressed images with their sources: stratified VMAF/PSNR/SSIM for video, color-managed SSIM/PSNR/RMSE for JPEG/PNG-to-AVIF/WebP/JXL, and optional SSIMULACRA2 for both. Never modifies either input. |
