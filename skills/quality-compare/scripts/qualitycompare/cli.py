...
def main(argv: list[str] | None = None) -> None:
    ...
    try:
        ...
        if media_type == "image":
            with tempfile.TemporaryDirectory(prefix="quality-compare-image-") as temp_name:
        ...
        with tempfile.TemporaryDirectory(prefix="quality-compare-") as temp_name:
            temp = Path(temp_name)
