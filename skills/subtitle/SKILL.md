...
```bash
python3 .agents/skills/subtitle/scripts/subtitle/__main__.py --path /library/Movies --language en
python3 .agents/skills/subtitle/scripts/subtitle/__main__.py --path /library/show.mkv --language en --yes
```
