...
from psammophis.medialib import colorinfo
from psammophis.medialib.svt import (
    SvtImplementation,
...
def build_command(
    ...
    # -nostats keeps human frame= ticks off stderr so the diagnostic log stays
    # clean and progress parsing does not scrape terminal-oriented lines.
    cmd = [
        "ffmpeg",
        "-y",
        "-nostdin",
